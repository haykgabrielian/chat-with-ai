    ...
    return (
        <Container>
            ...
            <Subtitle>
                ...
                Start chatting to explore the possibilities!
            </Subtitle>
            ...
            <FeaturesGrid>
                <FeatureCard>
                    ...
                    <FeatureDescription>
                        Engage in natural, intelligent conversations with AI that understands context and provides thoughtful responses.
                    </FeatureDescription>
                </FeatureCard>
                ...
                <FeatureCard>
                    ...
                    <FeatureDescription>
                        Your conversations are saved locally, so you can continue where you left off and revisit past discussions.
                    </FeatureDescription>
                </FeatureCard>
                ...
                <FeatureCard>
                    ...
                    <FeatureDescription>
                        Your data stays on your device. No cloud storage, no tracking - complete privacy and control over your conversations.
                    </FeatureDescription>
                </FeatureCard>
                ...
                <FeatureCard>
                    ...
                    <FeatureDescription>
                        Enjoy a clean, modern interface designed for seamless conversations with smooth animations and intuitive controls.
                    </FeatureDescription>
                </FeatureCard>
            </FeaturesGrid>
        </Container>
